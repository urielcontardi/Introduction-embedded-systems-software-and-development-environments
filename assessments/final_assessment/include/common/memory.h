...
/**
 * @brief Moves a block of data from one location to another, handling overlap
 *
...
/**
 * @brief Copies a block of data from one location to another (no overlap handling)
 *
 * @param src Pointer to the source memory location
 * @param dst Pointer to the destination memory location
 ...
 * @param value Value to set in each byte
...
/**
 * @brief Allocates a block of memory for a given number of words
 *
